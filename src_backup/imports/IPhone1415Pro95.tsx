import svgPaths from "./svg-9ycgwyye08";
...
function CameraFrame() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0" data-name="Camera Frame">
      <div className="bg-[#f6f6f6] col-1 h-[184.249px] ml-[5.89px] mt-[3.37px] rounded-[10px] row-1 w-[268.38px]" data-name="Camera Overlay" />
      <div className="col-1 h-[185.09px] ml-0 mt-0 relative rounded-[15px] row-1 w-[281px]" data-name="Passport Front 1">
...
function InputField() {
  return (
    <div className="content-stretch flex flex-col h-[25px] items-center relative shrink-0 w-[109px]" data-name="Input Field">
      <CameraFrame />
    </div>
  );
}
...
function InputFieldContainer() {
  return (
    <div className="absolute content-stretch flex flex-col h-[183px] items-center left-[30px] top-[228px] w-[287px]" data-name="Input Field Container">
...
function VerificationMessageContainer() {
  return (
    <div className="absolute content-stretch flex flex-col items-end left-[39px] top-[433px]" data-name="Verification Message Container">
...
function Group() {
  return (
    <div className="absolute left-[147px] size-[46px] top-[165px]">
...
function Buttons() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[19px] top-[493px] w-[310px]" data-name="Buttons">
      <ButtonsCta />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 absolute bg-white h-[617px] left-1/2 rounded-[10px] shadow-[0px_0px_35px_0px_rgba(0,0,0,0.05)] top-[72px] w-[351px]">
      ...
      <Group />
      <Buttons />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[174px] not-italic text-[#242424] text-[16px] text-center top-[557px]">Rescan</p>
    </div>
  );
}
...
export default function IPhone1415Pro() {
  return (
    <div className="bg-[#fbfcfc] relative size-full" data-name="iPhone 14 & 15 Pro - 95">
      <Frame1 />
      <Frame />
      <Frame2 />
