import svgPaths from "./svg-hjw0s9gfaw";
    ...
    <div className="col-1 h-[320px] ml-0 mt-0 relative row-1 w-[319px]" data-name="Camera Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 319 320">
        <g id="Camera Frame">
          ...
          <path d={svgPaths.p1bba2700} fill="var(--fill-0, #4967FF)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame() {
  return (
    <div className="absolute h-[100px] left-[132px] top-[286px] w-[95px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 95 100">
        <g id="Frame">
          <g id="Vector" />
          <path d={svgPaths.p1cd3fe80} fill="var(--fill-0, #4967FF)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
export default function IPhone1415Pro() {
  return (
    <div className="bg-[#fbfcfc] relative size-full" data-name="iPhone 14 & 15 Pro - 92">
      <Frame2 />
      <Frame1 />
      <Frame3 />
